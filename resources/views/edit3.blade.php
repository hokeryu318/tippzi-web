    ...
    <div class="t-content">
        <div class="row reg-content">
            ...
            <div class="col-lg-4 col-md-8 col-sm-8">
                ...
                <form action="{{ route('bar.update3') }}" method="POST">
                    @csrf
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0">
                                    <div class='input-group date' id='mon_start'>
                                        <input type='text' class="form-control" id="mon_start-input" name="mon_start" value="{{ get_template_variable('mon_start', $bar_time) }}" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0;">
                                    <div class='input-group date' id='mon_end'>
                                        <input type='text' class="form-control" id="mon_end-input" name="mon_end" value="{{ get_template_variable('mon_end', $bar_time) }}" style="" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0">
                                    <div class='input-group date' id='tue_start'>
                                        <input type='text' class="form-control" id="tue_start-input"  name="tue_start" value="{{ get_template_variable('tue_start', $bar_time) }}" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0;">
                                    <div class='input-group date' id='tue_end'>
                                        <input type='text' class="form-control" id="tue_end-input" name="tue_end" value="{{ get_template_variable('tue_end', $bar_time) }}" style="" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0">
                                    <div class='input-group date' id='wed_start'>
                                        <input type='text' class="form-control" id="wed_start-input" name="wed_start" value="{{ get_template_variable('wed_start', $bar_time) }}" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0;">
                                    <div class='input-group date' id='wed_end'>
                                        <input type='text' class="form-control" id="wed_end-input" name="wed_end" value="{{ get_template_variable('wed_end', $bar_time) }}" style="" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0">
                                    <div class='input-group date' id='thur_start'>
                                        <input type='text' class="form-control" id="thur_start-input" name="thur_start" value="{{ get_template_variable('thur_start', $bar_time) }}" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0;">
                                    <div class='input-group date' id='thur_end'>
                                        <input type='text' class="form-control" id="thur_end-input" name="thur_end" value="{{ get_template_variable('thur_end', $bar_time) }}" style="" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0">
                                    <div class='input-group date' id='fri_start'>
                                        <input type='text' class="form-control" id="fri_start-input" name="fri_start" value="{{ get_template_variable('fri_start', $bar_time) }}" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0;">
                                    <div class='input-group date' id='fri_end'>
                                        <input type='text' class="form-control" id="fri_end-input" name="fri_end" value="{{ get_template_variable('fri_end', $bar_time) }}" style="" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0">
                                    <div class='input-group date' id='sat_start'>
                                        <input type='text' class="form-control" id="sat_start-input" name="sat_start" value="{{ get_template_variable('sat_start', $bar_time) }}" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0;">
                                    <div class='input-group date' id='sat_end'>
                                        <input type='text' class="form-control" id="sat_end-input" name="sat_end" value="{{ get_template_variable('sat_end', $bar_time) }}" style="" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0">
                                    <div class='input-group date' id='sun_start'>
                                        <input type='text' class="form-control" id="sun_start-input" name="sun_start" value="{{ get_template_variable('sun_start', $bar_time) }}" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" style="margin: 8px 0;">
                                    <div class='input-group date' id='sun_end'>
                                        <input type='text' class="form-control" id="sun_end-input" name="sun_end" value="{{ get_template_variable('sun_end', $bar_time) }}" style="" readonly/>
                                        <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                    </div>
...
<script type="text/javascript">
    ...
    function previous()
    {
        location.href = "<?php echo route('bar.edit', ['id' => $id, 'step' => 2]) ?>";
    }
